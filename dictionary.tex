...
% Per-face fallback chains: Lexicon No1 is Latin-only (217 glyphs), so
% the vendored Gentium supplies Greek, Cyrillic and symbols (e.g. the
% swung dash) in the matching face; DejaVu Serif stays as last resort.
\directlua{
...
% Main face: Lexicon No1 (TEFF; commercial, installed system-wide, NOT
% vendored -- building this document requires it). Weight mapping:
% Roman A for text, Roman D as the bold, Italic A/D for the italics.
% The vendored Gentium/Charis (fonts/, see ACKNOWLEDGEMENTS.md for
% licences) serve as script fallback and IPA face respectively.
